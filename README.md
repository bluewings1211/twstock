...
### Build Your Own twstock Image

```
$ git clone https://github.com/bluewings1211/twstock
$ cd twstock
$ docker build . -t jeffchan/twstock
```

### Pull Image From DockerHub

If you don't want to build image by yourself, you can pull
image from DockerHub.

```
$ Docker pull jeffchan/twstock
```

### Run Container as CLI

```
$ docker run --rm jeffchan/twstock -b 2330
四大買賣點判斷 Best Four Point
------------------------------
...
```
$ docker run --rm jeffchan/twstock -s 2330
-------------- 2330 ----------------
